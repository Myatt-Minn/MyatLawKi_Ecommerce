...
class NewfeedDetailPage extends StatefulWidget {
  ...
  const NewfeedDetailPage({super.key, required this.id, required this.controller, required this.postData});
            ...
            CustomScrollView(
              ...
              slivers: [
                SliverList(
                    ...
                    Get.back();
                  }, icon: Icon(CupertinoIcons.back,color: ConstsConfig.primarycolor,size: 26,)),
                                CircularImage(source: 'assets/icon.png',radius: 15,borderWidth: 1,borderColor: Colors.white,),
                                Gap(10),
                                Text(
                                  textAlign: TextAlign.center,
                                  widget.controller.postData.value.poster.toString(),
                                  style: GoogleFonts.outfit(textStyle:  TextStyle(color: Colors.black54,fontSize: 17,fontWeight: FontWeight.bold)),
                                ),                      ],
                            ),
                            Gap(10),
                            Text(widget.controller.postData.value.description.toString(),style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.normal),),
                            Gap(10),
                                  ...
                                  itemBuilder: (BuildContext context, int index){
                                    return GestureDetector(
                                      onTap: (){
                                        ...
                                        Get.to(ViewAllImagesScreen(images: widget.controller.postData.value.images, indexImg: index,));
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Gap(6),
                                            Text(widget.controller.postData.value.images![index].description.toString(),style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.bold),),
                                            Gap(6),
                            ...
                            Container(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    CommentModel comData=widget.controller.postData.value.comments![index];
                                    return Row(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Container(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text(widget.controller.postData.value.comments![index].poster.toString(),style: TextStyle(color: Colors.black,fontSize: 13,fontWeight: FontWeight.bold)),
                                                  Text(widget.controller.postData.value.comments![index].body.toString(),style: TextStyle(color: Colors.black,fontSize: 12,fontWeight: FontWeight.normal))
                                                ],
                                              ),
                                            ),
                                            CupertinoButton(
                                                child: Text(widget.controller.postData.value.comments![index].replies!.length!=0?"View "+widget.controller.postData.value.comments![index].replies!.length.toString()+" Reply":"Reply",
                                                    style: GoogleFonts.outfit(textStyle:  TextStyle(color: widget.controller.postData.value.comments![index].replyShow==true && widget.controller.postData.value.comments![index].id==widget.controller.parent_id.value?ConstsConfig.primarycolor:Colors.black45,fontSize: 12,fontWeight: FontWeight.normal))),
                                                onPressed: () {
                                                  setState(() {
                                                    ...
                                                    children: [
                                                      ...
                                                      Flexible(child: Container(
                                                        ...
                                                        child: Column(
                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                                          children: [
                                                            Text(widget.controller.postData.value.comments![index].replies![i].poster.toString(),style: TextStyle(color: Colors.black,fontSize: 12,fontWeight: FontWeight.bold)),
                                                            Text(widget.controller.postData.value.comments![index].replies![i].body.toString(),style: TextStyle(color: Colors.black,fontSize: 12,fontWeight: FontWeight.normal))
                                                          ],
                                                        ),
                                                      ))
                                                    ],
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              labelStyle: TextStyle(fontSize: 12,color: ConstsConfig.primarycolor),
