...
import '../app/modules/postCard/controllers/post_card_controller.dart';


class CommentAlertWidget extends StatefulWidget {
  final Post postData;
  final FeedsController controller;
  const CommentAlertWidget({super.key, required this.postData, required this.controller});
                                                    ...
                                                    children: [
                                                      ...
                                                      Flexible(child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Text(widget.controller.postData.value.comments![index].replies![i].poster.toString(),style: TextStyle(color: Colors.black,fontSize: 12,fontWeight: FontWeight.normal)),
                                                            Text(widget.controller.postData.value.comments![index].replies![i].body.toString(),style: TextStyle(color: Colors.black,fontSize: 11,fontWeight: FontWeight.normal))
                                                          ],
                                                        ),
                                                      ))
                                                    ],
